...
//working_leaves=status
//vacation_days_spent=кем работает
global $id;
...
if(isset($_GET['dop'])){
    ...
    $_SESSION['s']=$newid;
//    echo $newid;
//    header("Location: vacation2.php?get1=$newid");
...
<!--        --><?php //foreach ($data as $user){?>
    ...
    <h3>Внести изменения: </h3>
        ...
        <p>Позиция: <input class="form_input" type="text" name="vacation_days_spent" value="<?= $data[$id-1]{'vacation_days_spent'} ?>"/></p>
<!--        <p>Административные дни:<input class="form_input" type="text" name="administrative_days" value="--><?//= $data[$id-1]{'administrative_days'} ?><!--"/></p>-->
<!--        <p>Статус:<input class="form_input" type="text" name="working_leaves"  value="--><?//= $data[$id-1]{'working_leaves'} ?><!--"/></p>-->
    <p><select class="form_input" name="working_leaves" value="<?= $data[$id-1]{'working_leaves'} ?>">
            <option value="Работает в штатном режиме">Работает в штатном режиме</option>
...
<!--            <td>Дата трудоустройства</td>-->
        ...
        <?php foreach ($data as $user){?>
            <tr>
                <td><a href="?upd=<?= $user{'id'} ?>"><?= $user{'id'} ?></td>
                <!--            <td>--><?//= $user{'name'} ?><!--</td>-->
                <td><a href="?dop=<?= $user{'id'} ?>"><?= $user{'name'} ?></a></td>
...
<form action="" method="POST" class="add_worker">
    ...
    <p>Позиция: <input class="form_input" type="text" name="vacation_days_spent"/></p>
...
<!--    <p>Дни с отработкой: <input class="form_input" type="text" name="working_leaves" /></p>-->
    ...
    <p><select class="form_input" name="working_leaves">
            <option value="Работает в штатном режиме">Работает в штатном режиме</option>
            <option value="На больничном">На больничном</option>
            <option value="В отпуске">В отпуске</option>
        </select></p>
